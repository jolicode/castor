...
add_test(['arguments:passthru', 'before', '--', 'a', 'b', '--', '--no', '--foo', 'bar', '-x'], 'ArgumentsPassthruAfterOptionNoOption');
add_test(['arguments:passthru', 'before', '--custom-option', '--', 'a', 'b'], 'ArgumentsPassthruAfterOptionWithOptionBefore');
add_test(['arguments:passthru', 'before', '--', 'a', 'b', '--custom-option'], 'ArgumentsPassthruAfterOptionWithOptionAfter');
