...
add_test(['arguments:passthru-after-endoption', 'before', '--', 'a', 'b', '--', '--no', '--foo', 'bar', '-x'], 'ArgumentsPassthruAfterOptionNoOption');
add_test(['arguments:passthru-after-endoption', 'before', '--custom-option', '--', 'a', 'b'], 'ArgumentsPassthruAfterOptionWithOptionBefore');
add_test(['arguments:passthru-after-endoption', 'before', '--', 'a', 'b', '--custom-option'], 'ArgumentsPassthruAfterOptionWithOptionAfter');
