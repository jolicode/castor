...
#[AsSymfonyTask(name: 'symfony:hello', console: [__FILE__])] // We need to force PHP binary to support windows
...
#[AsCommand('greet')]
#[AsSymfonyTask(name: 'symfony:greet', console: [__FILE__])] // We need to force PHP binary to support windows
